...
class LogintobogganProfileForm extends ProfileForm {
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    //todo: check if there's a name field on the form. If so, does it contain mail or name. If
    //mail, is it same as user's mail
  ...
  public function save(array $form, FormStateInterface $form_state) {
    //stctodo = check value of trusted role. wonder if I could do it as a static for reuse inside this class?
    //check if trusted role appears in new_roles but was not in old roles. If so send an email about account
    //being activated. Once tested remove hook_user_update. Check this doesn't mess up saving.
    $currentuser = \Drupal::currentUser();
